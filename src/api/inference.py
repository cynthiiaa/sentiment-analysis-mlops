...
async def predict(request: PredictionRequest):
    ...
    try:
        ...
        for result in results:
            metrics_collector.track_prediction(result, latency / len(results))
            drift_detectior.add_prediction(result["confidence"], result["sentiment"])
...
async def get_metrics():
    ...
    return {**metrics, "drift_status": drift_status}
